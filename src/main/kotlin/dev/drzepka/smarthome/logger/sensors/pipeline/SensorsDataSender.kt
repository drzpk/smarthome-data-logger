...
class SensorsDataSender(private val executor: SensorsRequestExecutor) : DataSender<Measurement> {
    private val log by Logger()

    override suspend fun send(items: Collection<QueueItem<Measurement>>) {
